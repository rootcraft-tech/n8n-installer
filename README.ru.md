...
# Установка необходимых утилит для скачивания скриптов
...
#### Для HTTPS установки (install-n8n.sh):
- Откройте: `https://yourdomain.com`

#### Для HTTP установки (simple-install.sh): 
- Откройте: `http://your-server-ip:5678`
- Пример: `http://n8n.tech:5678`
```
